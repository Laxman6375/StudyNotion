...
const CourseDetails = () => {
  ...
  const handelAddToCart = () => {
    if (token) {
      dispatch(addToCart(courseDetail?.data[0]));
  ...
  //console.log(courseDetail.data[0]);
          ...
          <div className="z-30 my-5 flex flex-col justify-center gap-4 py-5 text-lg text-richblack-5">
            ...
            <div className="flex flex-wrap gap-5 text-lg">
              ...
              <p className="text-richblack-50">
                Created at &nbsp;
                {new Date(
                  createdAt || courseDetail?.data[0]?.updatedAt
              ...
              <>
                ...
                {alreadyEnrolled ? (
                  <div></div>
                    ...
                    (item) => item?._id === courseDetail?.data[0]?._id
                  ) ? (
                  <button
                    onClick={() => {
                      navigate("/dashboard/cart");
                    }}
                    className=" bg-richblack-900 font-medium text-base leading-6 py-3 px-6 text-richblack-5 rounded-lg"
                  >
                    Go to Cart
                  </button>
                ) : (
                  ...
                  <>
                    ...
                    {alreadyEnrolled ? (
                      ...
                      <button
                        ...
                        className=" bg-richblack-800 font-medium text-base leading-6 py-3 px-6 text-richblack-5 rounded-lg"
                      >
                        Go to Cart
                      </button>
                    ) : (
            ...
            <div className="mt-5">
              <div className="flex items-center gap-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-richblack-50">
                    {" "}
                    {studentEnrolled?.length} students
                  </span>
                </div>
              </div>
            </div>
